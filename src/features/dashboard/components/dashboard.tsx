...
import { LoginLogs, LoginLogsRef } from './login-logs'
      ...
      <div className="flex items-center justify-between space-y-2">
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            size="sm"
            onClick={handleRefreshLoginLogs}
            className="h-8 gap-1"
          >
      ...
      <Tabs defaultValue="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  共有 {" "}
                  <span className="font-medium">+{(2350 * 0.7).toFixed(0)}</span> 笔销售完成
                </CardDescription>
              </CardHeader>
              <CardContent>
                <RecentSales />
        ...
        <TabsContent value="logs" className="space-y-4">
          <Card className="col-span-3">
            ...
            <CardContent>
              <LoginLogs ref={loginLogsRef} autoLoad={true} />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
